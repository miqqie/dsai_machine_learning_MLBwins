...
4. **Per-Game Normalisation Beats Raw Totals**: Normalised features (e.g. runs per game) improved predictive power.  
5. **Regularisation Prevents Overfitting**: L2 regularisation in KRR helped stabilise results.  
6. **Interpretability Counts**: A simpler, well-regularised model gave clearer insights and more reliable outcomes than a “black box” approach.  
